...
import {readTextFile, splitTextIntoChunks, writeTextFile} from './lib/text.js';
...
const main = async () => {
  ...
  if (outputFlag === '-o' && inputPath && outputPath) {
    ...
    const chunks = splitTextIntoChunks(data, 5000);
    ...
    console.log('Usage: node improve_autosplit.js <text_file> -o <output_file.txt>');
  }
}
